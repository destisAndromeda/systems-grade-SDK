import { airdropFactory, ClientWithAirdrop } from '@solana/kit';
type RpcClient = {
 ...
 */
export declare function rpcAirdrop(): <T extends RpcClient>(client: T) => Omit<T, "airdrop"> & ClientWithAirdrop;
export {};
