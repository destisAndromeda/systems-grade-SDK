import { Rpc, RpcSubscriptions } from '@solana/kit';
/**
 ...
 * ```
 */
export declare function rpcConnection<TApi>(rpc: Rpc<TApi>): <T extends object>(client: T) => Omit<T, "rpc"> & {
    rpc: Rpc<TApi>;
};
/**
 ...
 * ```
 */
export declare function rpcSubscriptionsConnection<TApi>(rpcSubscriptions: RpcSubscriptions<TApi>): <T extends object>(client: T) => Omit<T, "rpcSubscriptions"> & {
    rpcSubscriptions: RpcSubscriptions<TApi>;
};
