 ...
 * @see {@link identity}
 */
export declare function signer<TSigner extends TransactionSigner>(signer: TSigner): <T extends object>(client: T) => Omit<T, "identity" | "payer"> & {
    identity: TSigner;
    payer: TSigner;
};
/**
 ...
 * @see {@link signer}
 */
export declare function payer<TSigner extends TransactionSigner>(payer: TSigner): <T extends object>(client: T) => Omit<T, "payer"> & {
    payer: TSigner;
};
/**
 ...
 * @see {@link signer}
 */
export declare function identity<TSigner extends TransactionSigner>(identity: TSigner): <T extends object>(client: T) => Omit<T, "identity"> & {
    identity: TSigner;
};
