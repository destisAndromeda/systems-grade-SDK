 ...
 */
export declare function airdropSigner(amount: Lamports): <T extends ClientWithAirdrop & ClientWithIdentity & ClientWithPayer>(client: T) => Promise<T>;
/**
 ...
 */
export declare function airdropPayer(amount: Lamports): <T extends ClientWithAirdrop & ClientWithPayer>(client: T) => Promise<T>;
/**
 ...
 * @see {@link airdropSigner}
 */
export declare function airdropIdentity(amount: Lamports): <T extends ClientWithAirdrop & ClientWithIdentity>(client: T) => Promise<T>;
//# sourceMappingURL=airdrop-signer.d.ts.map